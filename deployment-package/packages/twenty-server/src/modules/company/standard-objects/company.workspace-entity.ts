...
export class CompanyWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  // EarthCare Network specific fields
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.latitude,
    type: FieldMetadataType.NUMBER,
    label: msg`Latitude`,
    description: msg`Geographic latitude for mapping`,
    icon: 'IconMapPin',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.longitude,
    type: FieldMetadataType.NUMBER,
    label: msg`Longitude`,
    description: msg`Geographic longitude for mapping`,
    icon: 'IconMapPin',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.description,
    type: FieldMetadataType.TEXT,
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.claimed,
    type: FieldMetadataType.BOOLEAN,
    label: msg`Claimed`,
    description: msg`Whether the company profile has been claimed`,
    icon: 'IconCheck',
    defaultValue: false,
  })
  claimed: boolean;
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.claimedBy,
    type: FieldMetadataType.TEXT,
    label: msg`Claimed By`,
    description: msg`Email of person who claimed the profile`,
    icon: 'IconUser',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.claimedDate,
    type: FieldMetadataType.DATE_TIME,
    label: msg`Claimed Date`,
    description: msg`Date when the profile was claimed`,
    icon: 'IconCalendar',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.verified,
    type: FieldMetadataType.BOOLEAN,
    label: msg`Verified`,
    description: msg`Whether the company has been verified`,
    icon: 'IconBadgeCheck',
    defaultValue: false,
  })
  verified: boolean;
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.pledgeSigned,
    type: FieldMetadataType.BOOLEAN,
    label: msg`EarthCare Pledge Signed`,
    description: msg`Whether the company signed the EarthCare pledge`,
    icon: 'IconLeaf',
    defaultValue: false,
  })
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.pledgeDate,
    type: FieldMetadataType.DATE_TIME,
    label: msg`Pledge Date`,
    description: msg`Date when the EarthCare pledge was signed`,
    icon: 'IconCalendar',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.category,
    type: FieldMetadataType.TEXT,
    label: msg`Category`,
    description: msg`Business category`,
    icon: 'IconTag',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.tags,
    type: FieldMetadataType.TEXT,
    label: msg`Tags`,
    description: msg`Comma-separated tags for the business`,
    icon: 'IconTags',
  })
  @WorkspaceIsNullable()
  tags: string | null;
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.logoUrl,
    type: FieldMetadataType.TEXT,
    label: msg`Logo URL`,
    description: msg`URL to company logo`,
    icon: 'IconPhoto',
  })
  @WorkspaceIsNullable()
  logoUrl: string | null;
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.coverImageUrl,
    type: FieldMetadataType.TEXT,
    label: msg`Cover Image URL`,
    description: msg`URL to company cover image`,
    icon: 'IconPhoto',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.businessHours,
    type: FieldMetadataType.TEXT,
    label: msg`Business Hours`,
    description: msg`Operating hours of the business`,
    icon: 'IconClock',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.socialLinks,
    type: FieldMetadataType.TEXT,
    label: msg`Social Links`,
    description: msg`JSON object containing social media links`,
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.buildProTrialStarted,
    type: FieldMetadataType.BOOLEAN,
    label: msg`Build Pro Trial Started`,
    description: msg`Whether the company started a Build Pro trial`,
    icon: 'IconRocket',
    defaultValue: false,
  })
  buildProTrialStarted: boolean;

  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.buildProTrialDate,
    type: FieldMetadataType.DATE_TIME,
    label: msg`Build Pro Trial Date`,
    description: msg`Date when Build Pro trial was started`,
    icon: 'IconCalendar',
  })
  @WorkspaceIsNullable()
  buildProTrialDate: Date | null;
